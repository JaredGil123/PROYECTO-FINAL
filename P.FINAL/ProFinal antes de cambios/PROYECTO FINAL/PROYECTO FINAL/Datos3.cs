...
namespace BISECCION
{
    public partial class Datos3 : Form
    {
        public Datos3()
        {
            InitializeComponent();
        ...
        {
            //Verifica si X o Y están vacios, si si, regresa y corta el codigo a ese punto
            ...
            if (Resultado == DialogResult.Yes)
            {
                ...
                {
                    fa = (a * Math.Pow(x, 2)) + (b * x) + c;
                    fb = (a * Math.Pow(y, 2)) + (b * y) + c;
